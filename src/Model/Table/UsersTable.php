 ...
 */class UsersTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('request_reset_password', 'create')            ->notEmpty('request_reset_password');
        $validator
            ->integer('status')            ->requirePresence('status', 'create')            ->notEmpty('status');*/
        return $validator;
    }
	...
	public function identify($formData) { 
        $passOk = false;
        $user = $this->find()->hydrate(false)->where(['email' => $formData['email']])->orWhere(['email' => $formData['email']])->first();
    ...
    public function beforeMarshal(Event $event, \ArrayObject $data, \ArrayObject $options) {  //pr($data);exit;
