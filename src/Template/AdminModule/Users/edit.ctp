...
"group_id" : {required :"Please enter group_id."},
"first_name" : {required :"Please enter first_name."},
"last_name" : {required :"Please enter last_name."},
"email" : {required :"Please enter email."},
"password" : {required :"Please enter password."},
"request_reset_password" : {required :"Please enter request_reset_password."},
			...
			<div class="tab-pane active" id="tab_0">
				<div class="portlet box blue">
					...
					<div class="portlet-body form locations">
						...
						<?php echo $this->Form->create($user,array('class'=> 'form-horizontal','id'   =>'EditUserForm')) ?>
						<div class="form-body">
